...
c);var f=b.I;b.I=function(a){a.setRequestHeader("X-HTTP-Method-Override",c);if(f)return f.apply(this,arguments)}}"GET"===d.type||b.emulateJSON||(d.processData=!1);"PATCH"!==d.type||!window.ActiveXObject||window.external&&window.external.V||(d.xhr=function(){return new ActiveXObject("Microsoft.XMLHTTP")});b.xhr=a.ajax(e.extend(d,b))}function ma(a){return function(b){window.history[a+"State"]({},"",b);r(window).trigger(a+"state")}}function xa(a,b){return a.replace(ya,function(a,d,f,g){return ca[g]||
d||ba.test(g)?a:null!=b[g]?["(",g," && view.isQueryable(",g,") ? ",g,'.query("',f.slice(g.length+1),'") : ',f,")"].join(""):['view.query(2, "',f,'")'].join("")})}function za(a){function b(){d=e.invert(e.flatten(c))}var c=[[]],d={};b();a=a.replace(Aa,function(a,g,e){function h(){var a=xa(l.join(""),d);l=[];return a}var l=[];(a="@"===g)&&(g="");e=e.replace(Ba,function(a,d,f){return d.replace(Ca,function(a,d,f,g,e,I){if(I)return l.push(I),"";g?c.push([]):d?d.replace(Da,function(a){c[c.length-1].push(a)}):
e&&c.pop();b();return h()+a})+h()+(f||"")})+h();return"<%"+(a?"= view.getHashId("+e+") ":g?g+"view.denullText("+e+")":e)+"%>"});return e.template(a,null,{variable:"view"})}function Ea(a,b){var c=L[a];null==c&&(c=r('script[name="'+a+'"]').html()||"");"string"===typeof c&&(c=L[a]=za(c));return c(b)}function na(a,b,c){var d={};e.each(c||[],function(a){(d[a.w]=d[a.w]||[]).push(a)});return e.map(a,function(a){var c=r(a),e=a.outerHTML,h=a.__tboneview__;if(!h){if(d[e]&&d[e].length)e=d[e].shift(),c.replaceWith(e.el),
h=e;else{var l={};(c.attr("tbone")||"").replace(Fa,function(a,b,c){l[b]=c});if(h=l.inline){var m=c.html().replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&amp;/g,"&");L[h]=m}var D=h||l.tmpl,h=l.root,q=l.view||D,m=P[q]||da;c.addClass(q);for(var n=m.B;n&&n.Name;)c.addClass(n.Name),n=n.B;c={Name:q,w:e,el:a,q:D,d:b,C:Q[h]||k,D:Q[h]?"":h};delete Q[h];h=m.make(c)}a.__tboneview__=h}return h})}var m,e,r;"undefined"!==typeof exports?(e=require("underscore")._,m=exports):(m=window,e=m._,r=m.$);var u={},
...
function(b){var c=b.obj;b=b.props;if(b[""])c.on("change",a.trigger,a);else for(var g in b)c.on("change:"+g,a.trigger,a)}),a.v&&a.v.call(a.K,this),w=b,s=c}}},H:function(){var a=this.o||{},b;for(b in a){var c=a[b],d=c.obj,c=c.props,e;for(e in c)d.off("change:"+e,null,this)}},s:function(){for(var a=0;a<this.i.length;a++)this.i[a].destroy();this.i=[]},destroy:function(){this.l=!0;delete this.A;this.H();this.s()}});var ha=1,M=[],U,W={},C,v=0,ua=k.isReady=function(){return!v&&!C},V,N=this.$&&r.fn&&r.fn.scrollTop,
ka=N&&r(window),Z;N&&(r.fn.scrollTop=function(a){a&&(Z=!0);return N.apply(this,arguments)});k.drain=function(){C&&clearTimeout(C);X()};var oa=u.bound=n.extend({initialize:function(){this.scope=t(this.update,this.F,this,this.Name&&"model_"+this.Name,this.f,this,!0)},F:3E3,c:function(a){this.a&&(this.a=!1,this.reset());e.each(this.scope&&this.scope.o||[],function(b){(b=b.obj)&&!a[y(b)]&&(a[y(b)]=!0,b.c(a))})},f:function(){},update:function(){(this.a=this.sleepEnabled&&!fa(this))||this.r()},r:function(){this.query(this.assumeChanged?
...
!0;c()}function c(){null!=g&&(d.unset(g,null),d.trigger("change:"+g),delete d.g[g]);if(!k){var a=e.queryId();null==a&&(a="__unidentified"+Ja++);a="#"+a;d.query(a,e);d.trigger("change:"+a);d.g[a]=b;g=a}}var d=this,e,g;A(a)?e=a:(e=d.model.make(),e.query("",a));var k;d.increment("size");t(c)},remove:function(a){a="#"+(A(a)?a.queryId():a);if(this.g[a])this.g[a]()}});k.collections=G;var wa={create:"POST",update:"PUT",patch:"PATCH","delete":"DELETE",read:"GET"};u.ajax=ea.extend({state:function(a){function b(){d&&
...
this;a.query("",JSON.parse(localStorage[a.key]||"null"));t(function(){localStorage[a.key]=JSON.stringify(a.X(""))})}});u.location=n.extend({initialize:function(){function a(){if(c=b("hash")!==location.hash||b("search")!==location.search||b("pathname")!==location.pathname)b("hash",location.hash),b("pathname",location.pathname),b("search",location.search)}var b=this,c;r(window).bind("hashchange popstate pushstate replacestate",a);a();b(function(){var a=b("pathname"),e=b("search"),g=b("hash");c||b.pushPath(a+
(e||"")+(g?"#"+g:""));c=!1})},pushPath:ma("push"),replacePath:ma("replace")});G.localStorage=Ka.extend({initialize:function(){var a=this,b=JSON.parse(localStorage[a.key]||"null");e.each(b||[],function(b){a.add(b)});t(function(){localStorage[a.key]=JSON.stringify(a.query())})}});var Aa=/<%(=|-|@|)([\s\S]+?)%>/g,Ca=RegExp("function \\( ([\\w$_]* (, [\\w$_]+)*)  \\)|(\\{)|(\\})|([\\s\\S])".replace(/ /g,"[\\s\\n]*"),"g"),Da=/[\w$_]+/g,Ba=/([^'"]+)('[^']+'|"[^"]+")?/g,ya=RegExp("(\\. )?(([\\w$_]+)(\\.[\\w$_]+)*)".replace(/ /g,
"[\\s\\n]*"),"g"),ca={};e.each("break case catch continue debugger default delete do else finally for function if in instanceof new return switch this throw try typeof var void while with Array Boolean Date Function Iterator Number Object RegExp String isFinite isNaN parseFloat parseInt Infinity JSON Math NaN undefined true false null $ _ tbone T view window".split(" "),function(a){ca[a]=!0});var Q={},pa=0,da=n={make:function(a){var b={};e.extend(b,this);b.initialize(a);return b},extend:function(a){return e.extend({},
this,a,{B:this})},$:function(a){return this.$el.find(a)},u:!0,initialize:function(a){y(this);e.extend(this,a);this.$el=r(this.el);this.el.view=this;this.b=this.d?this.d.b-1:2E3;this.scope=t(this.render,this.b,this,"view_"+this.Name,this.f,this,!0)},f:function(){},destroy:function(){var a=this;a.l=!0;a.scope.destroy();e.each(a.p||[],function(b){b.destroy(a)});a.destroyDOM(a.$el)},render:function(){var a=this,b,c,d,f,g;if(!a.l){pa++;if(a.q){b=document.activeElement;if(e.contains(r(b).parents(),a.el)){c=
"input";d=e.indexOf(a.$(c),b);try{f=b.selectionStart,g=b.selectionEnd}catch(k){}}b=r("<div>").append(this.$el.children());var h=Ea(a.q,a);a.$el.html(h)}a.ready();a.postReady();h=a.p||[];a.p=na(a.$("[tbone]"),a,h);h=e.difference(h,a.p);e.each(h,function(b){b.destroy(a)});if(a.q&&(a.destroyDOM(b),c&&(c=a.$(c)[d]))&&(r(c).focus(),null!=f&&null!=g))try{c.selectionStart=f,c.selectionEnd=g}catch(l){}Ga++;pa--}},ready:z,postReady:z,destroyDOM:function(){},root:function(){return this.query(1)},query:function(a,
...
L;k.createView=function(a,b,c,d){var f=[].slice.call(arguments),g=f.shift();"string"===typeof g?(a=g,g=f.shift()):a="v"+ha++;g&&g.extend?(b=g,g=f.shift()):b=da;"function"===typeof g?(c=g,g=f.shift()):c=null;d=e.extend({},g||{},{Name:a});var k=b.ready;c&&(d.ready=k===z?c:function(){k.call(this);c.call(this)});return P[a]=b.extend(d)};k.setDefaultView=function(a){da=a};k.addTemplate=function(a,b){L[a]=b};k.dontPatch=function(a){ca[a]=!0};k.render=na;k.denullText=R;k.priority={highest:1E4,bound:3E3,
beforeViews:2500,view:2E3,afterViews:1500,async:1E3,lowest:0};P.base=n;try{m.dispatchEvent(new m.CustomEvent("tbone_loaded"))}catch(La){}if(n=m.Backbone){var qa=function(a,b,c){var d=1===a,f=2===a,g=7===a,k=3===arguments.length,h=g||k;"number"!==typeof a&&(c=b,b=a,a=0,2===arguments.length&&(k=h=!0));b=(b||"").replace(/\.?(__self__)?\.?$/,"");var l=b.split("."),m;h&&(m=l[l.length-1]);for(var n,q=d&&!b?this:this.e?this.models:this.attributes,r=[],s=l[0]||"",u=b?q[s]:q,t,v;null!=(t=l.shift());)if(""!==
t)if(r.push(t),n=q,q=q[t],null==q)if(h)q=ba.exec(l[0])?[]:{},n[t]=q;else break;else if(A(q)){v=!0;break}!h&&w&&(r=y(this),w[r]||(w[r]={obj:this,props:{}}),w[r].props[s]=u);if(v&&(!d||l.length))return k?q.query(a,l.join("."),c):q.query(a,l.join("."));if(h){if(null==n)if(this.e)this.reset(null!=c?c:[]);else if(c){for(var x in this.toJSON())void 0===c[x]&&this.unset(x);this.set(c)}else this.clear();else g?c=n[m]=!q:n[m]!==c&&(n[m]=c),s&&this.trigger("change:"+s),this.trigger("change");return c}q&&!f&&
this.e&&""===b&&(q=e.map(q,function(a){return a.query()}));return q},ea=n.Model.extend({h:!0,initialize:function(){var a=this;y(a);var b=(a.a=a.t())?1E3:3E3;ja({execute:function(){a.scope=t(a.update,b,a,"model_"+a.Name,a.f,a)},b:b+5E3})},t:function(){return!!this._url},f:function(){},reset:function(){this.scope&&this.scope.trigger()},isVisible:function(){return fa(this)},update:function(){this.t()?this.M():this.O()},M:function(){function a(){c===b.j&&(v--,delete b.j)}var b=this,c,d=b.url(),e=b.m;
