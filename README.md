...
* [Development version, with comments](http://cdn.tbonejs.org/tbone-v0.4.1.js) *27kiB gzipped*
* [Production version, minified](http://cdn.tbonejs.org/tbone-v0.4.1.min.js) *7kiB gzipped*

```html
Development: <script src="http://cdn.tbonejs.org/tbone-v0.4.1.js"></script>
Production: <script src="http://cdn.tbonejs.org/tbone-v0.4.1.min.js"></script>
```
